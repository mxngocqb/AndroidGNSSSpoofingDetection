...
import com.example.pseudorange.Ecef2LlaConverter.GeodeticLlaValues;
import com.example.pseudorange.EcefToTopocentricConverter.TopocentricAEDValues;
import com.example.pseudorange.SatellitePositionCalculator.PositionAndVelocity;
    ...
    static List<GpsMeasurementWithRangeAndUncertainty> computePseudorangeAndUncertainties(
        ...
        for (int i = 0; i < GpsNavigationMessageStore.MAX_NUMBER_OF_SATELLITES; i++) {
            if (usefulSatellitesToTOWNs[i] != null) {
                ...
                usefulSatellitesToPseudorangeMeasurements.set(i,
                        new GpsMeasurementWithRangeAndUncertainty(
